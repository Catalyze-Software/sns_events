...
import { idlFactory } from './parent.did.js';
export { idlFactory } from './parent.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PARENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./parent.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the parent canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./parent.did.js")._SERVICE>}
 */
export const parent = createActor(canisterId);
