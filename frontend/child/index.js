...
import { idlFactory } from './child.did.js';
export { idlFactory } from './child.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CHILD_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./child.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the child canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./child.did.js")._SERVICE>}
 */
export const child = createActor(canisterId);
